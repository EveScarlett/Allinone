...
use Yii;
/**
 * UbicacionesSearch represents the model behind the search form of `app\models\Ubicaciones`.
 */
class UbicacionesSearch extends Ubicaciones
{
    ...
    public function rules()
    {
        return [
            ...
            [['ubicacion','id_linea','id_nivel1','id_nivel2','id_nivel3','id_nivel4'], 'safe'],
        ];
    }
