...
/**
 * This is the model class for table "nivel_organizacional3".
 *
 * @property int $id
 * @property int|null $id_empresa
 * @property int|null $id_nivel
 * @property int|null $id_nivelorganizacional1
 * @property int|null $id_nivelorganizacional2
 * @property string|null $nivelorganizacional3
 * @property int|null $status
 */
class NivelOrganizacional3 extends \yii\db\ActiveRecord
{
    public $aux_areas = [];
    public $aux_kpis = [];
    public $aux_puestos = [];
    ...
    {
        return [
            [['id_empresa', 'id_nivel', 'id_nivelorganizacional1', 'id_nivelorganizacional2', 'nivelorganizacional3', 'status'], 'default', 'value' => null],
            ...
            [['id_empresa', 'id_nivel', 'id_nivelorganizacional1', 'id_nivelorganizacional2', 'status','qty_trabajadores','kpi_actualiza','dias_sin_accidentes','actualiza_dias_sin_accidentes','nivel','id_nivelorganizacional3','id_nivelorganizacional4','objetivo_dias_sin_accidentes','record_dias_sin_accidentes','dias_sin_dig_0','dias_sin_dig_1','dias_sin_dig_2','dias_sin_dig_3','dias_sin_dig_4','accidentes_anio_dias_sin_accidentes'], 'integer'],
            [['nivelorganizacional3'], 'string', 'max' => 400],
            [['id_empresa','id_nivelorganizacional1','id_nivelorganizacional2','nivelorganizacional3','status'], 'required','on' =>['create','update']],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'id_nivelorganizacional1' => Yii::t('app', 'Nivel Superior 2'),
            'id_nivelorganizacional2' => Yii::t('app', 'Nivel Superior'),
            'nivelorganizacional3' => Yii::t('app', 'Nivel Organizacional 3'),
