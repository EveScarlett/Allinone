...
class ServiciosSearch extends Servicios
{
    ...
    {
        return [
            [['id', 'id_tiposervicio', 'orden', 'id_pruebalab','status'], 'integer'],
            [['nombre', 'nombre_completo','id_nivel1','id_nivel2','id_nivel3','id_nivel4'], 'safe'],
        ];
    }
    ...
    public function search($params)
    {
        ...
        $dataProvider = new ActiveDataProvider([
            'query' => $query,
            'sort' => ['defaultOrder' => ['status'=>SORT_ASC,'id_tiposervicio'=>SORT_ASC,'orden'=>SORT_ASC]]
        ]);

        //$query->orderBy(['status'=>SORT_ASC,'id_tiposervicio'=>SORT_ASC,'orden'=>SORT_ASC]);
        ...
        $dataProvider->sort->attributes['id_tiposervicio'] = [
            'asc' => ['id_tiposervicio' => SORT_ASC],
            'desc' => ['id_tiposervicio' => SORT_DESC]
        ];
        ...
        $query->andFilterWhere([
            ...
            'orden' => $this->orden,
            'status' => $this->status,
            'id_pruebalab' => $this->id_pruebalab,
        ]);
