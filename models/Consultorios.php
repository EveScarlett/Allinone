 ...
 */
class Consultorios extends \yii\db\ActiveRecord
{
    public $envia_form;
    /**
     * {@inheritdoc}
    ...
    public function rules()
    {
        return [
            ...
            [['consultorio'], 'string', 'max' => 300],
             [['id_empresa','id_pais','id_linea','consultorio','status'], 'required','on' =>['create','update']],
        ];
    }
    ...
    public function attributeLabels()
    {
        return [
            ...
            'consultorio' => Yii::t('app', 'Consultorio'),
