...
use app\models\TurnosempresaSearch;
use yii\web\Controller;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;
use Yii;
/**
 * TurnosempresaController implements the CRUD actions for Turnos model.
 */
class TurnosempresaController extends Controller
{
    /**
     * @inheritDoc
     */
    ...
    {
        $searchModel = new TurnosempresaSearch();
    ...
    {
        if (($model = Turnos::findOne(['id' => $id])) !== null) {
            return $model;
        }
