                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td colspan="1" class="border-bottom-dot">
                            <?php
                            $edad = '';
                            $dateOfBirth = trim($model->fecha_nacimiento);
                    ...
                    <tr>
                        ...
                        <td colspan="4" class="border-bottom-dot">
                            <?php
                            echo $model->tipo_identificacion_p;
                            ?>
                        </td>
                        <td colspan="1">
                        </td>
                        ...
                        <td colspan="3" class="border-bottom-dot">
                            <?php
                            echo $model->numero_identificacion_p;
                            ?>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td colspan="20" class="bgbadges"> ESTUDIOS A REALIZAR</td>
                    </tr>
                    <tr>
                        <td style="padding-top:10px;"></td>
                    </tr>
                    ...
                    if($estudios_ordenados){
                        ...
                        foreach($estudios_ordenados as $key=>$estudio){
                            ...
                            echo '<tr>
                                <td colspan="20" class="text-11 border-bottom">'.$est_estudio.'</td>
                                </tr>';
                        }
                    } else {
