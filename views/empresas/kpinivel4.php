...
<div class="ubicaciones-form p-3">
    ...
    <div class="row">
        ...
        <div class="col-lg-12" style="display:none;">
            <?= $form->field($model, 'id')->textInput(['maxlength' => true,'type'=>'hidden','id'=>'id_nivel4']) ?>
        </div>
        <div class="col-lg-12" style="display:none;">
        ...
        <div class="col-lg-12" style="display:none;">
            <?= $form->field($model, 'id_nivelorganizacional2')->textInput(['maxlength' => true,'type'=>'hidden','id'=>'id_nivel2']) ?>
        </div>
        <div class="col-lg-12" style="display:none;">
            <?= $form->field($model, 'id_nivelorganizacional3')->textInput(['maxlength' => true,'type'=>'hidden','id'=>'id_nivel3']) ?>
        </div>
        <div class="col-lg-12" style="display:none;">
    ...
    <div class="row">
        ...
        <div class="col-lg-12 title1 color3 mt-3 bgcolor16 rounded-3 p-2 px-3">
            <?php
            echo $model->nivelorganizacional4;
        ...
        <div class="row mt-3">
            ...
            <div class="col-lg-4">
                <div class="row">
                    <div class="col-lg-12">
                        <?php if($editar_nivel):?>
                        <?= $form->field($model, 'accidentes_anio_dias_sin_accidentes')->textInput(['class'=>"form-control font25 bgcolor22 px-2 py-3 text-center border-0 font-digital",'type'=>'number','min'=>0,'max'=>100000,'maxlength' => true, 'onkeyup' => 'cambiaAccidentes("4");'])->label(false) ?>
                        <?php else:?>
            ...
            <div class="col-lg-2">
                <?php if($editar_nivel):?>
                <?= $form->field($model, 'objetivo_dias_sin_accidentes')->textInput(['class'=>"form-control",'type'=>'number','min'=>0,'max'=>100000,'maxlength' => true, 'onkeyup' => 'cambiaAccidentes("4");'])->label(false) ?>
                <?php else:?>
                           ...
                           /*  [
                            ...
                            [
                                ...
                                'options' => [
                                    ...
                                    'onchange'=>'cambiaResultadokpi(this.id,"4")',
                                ],
                                'headerOptions' => [
                                    'class' => 'color9 font500',
