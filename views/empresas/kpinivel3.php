...
<div class="ubicaciones-form p-3">
    ...
    <div class="row">
        ...
        <div class="col-lg-12" style="display:none;">
            <?= $form->field($model, 'id')->textInput(['maxlength' => true,'type'=>'hidden','id'=>'id_nivel3']) ?>
        </div>
        <div class="col-lg-12" style="display:none;">
    ...
    <div class="row">
        ...
        <div class="col-lg-12 title1 color3 mt-3 bgcolor16 rounded-3 p-2 px-3">
            <?php
            echo $model->nivelorganizacional3;
        ...
        <div class="row mt-3">
            ...
            <div class="col-lg-4">
                <div class="row">
                    <div class="col-lg-12">
                        <?php if($editar_nivel):?>
                        <?= $form->field($model, 'accidentes_anio_dias_sin_accidentes')->textInput(['class'=>"form-control font25 bgcolor22 px-2 py-3 text-center border-0 font-digital",'type'=>'number','min'=>0,'max'=>100000,'maxlength' => true, 'onkeyup' => 'cambiaAccidentes("3");'])->label(false) ?>
                        <?php else:?>
            ...
            <div class="col-lg-2">
                <?php if($editar_nivel):?>
                <?= $form->field($model, 'objetivo_dias_sin_accidentes')->textInput(['class'=>"form-control",'type'=>'number','min'=>0,'max'=>100000,'maxlength' => true, 'onkeyup' => 'cambiaAccidentes("3");'])->label(false) ?>
                <?php else:?>
                           ...
                           /*  [
                            ...
                            [
                                ...
                                'options' => [
                                    ...
                                    'onchange'=>'cambiaResultadokpi(this.id,"3")',
                                ],
                                'headerOptions' => [
                                    'class' => 'color9 font500',
                    ...
                    if($id_inferiores && (count($id_inferiores)>0)){
                        ...
                        if($niveles_above){
                            foreach($niveles_above as $key=>$inferior){
                                ...
                                <thead>
                                <tr>
                                    <th class="bgcolor3 text-light font12 font500" colspan=3>'.$inferior->nivelorganizacional4.'</th>
