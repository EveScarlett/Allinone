...
<div class="ubicaciones-form p-3">
    ...
    <div class="row">
        ...
        <div class="col-lg-12" style="display:none;">
            <?= $form->field($model, 'id')->textInput(['maxlength' => true,'type'=>'hidden','id'=>'id_nivel1']) ?>
        </div>
        <div class="col-lg-12" style="display:none;">
        ...
        <div class="col-lg-12" style="display:none;">
            <?= $form->field($model, 'id_nivelorganizacional1')->textInput(['maxlength' => true,'type'=>'hidden','id'=>'id_nivel2']) ?>
        </div>
        <div class="col-lg-12" style="display:none;">
        ...
        <div class="row mt-3">
            ...
            <div class="col-lg-4">
                <div class="row">
                    <div class="col-lg-12">
                        <?php if($editar_nivel):?>
                        <?= $form->field($model, 'accidentes_anio_dias_sin_accidentes')->textInput(['class'=>"form-control font25 bgcolor22 px-2 py-3 text-center border-0 font-digital",'type'=>'number','min'=>0,'max'=>100000,'maxlength' => true, 'onkeyup' => 'cambiaAccidentes("1");'])->label(false) ?>
                        <?php else:?>
            ...
            <div class="col-lg-2">
                <?php if($editar_nivel):?>
                <?= $form->field($model, 'objetivo_dias_sin_accidentes')->textInput(['class'=>"form-control",'type'=>'number','min'=>0,'max'=>100000,'maxlength' => true, 'onkeyup' => 'cambiaAccidentes("1");'])->label(false) ?>
                <?php else:?>
        ...
        <div class="row mt-5">
            ...
            <div class="col-lg-12 table-responsive" style="width:1200px !important;">
                           ...
                           /*  [
                            ...
                            [
                                ...
                                'options' => [
                                    ...
                                    'onchange'=>'cambiaResultadokpi(this.id,"1")',
                                ],
                                'headerOptions' => [
                                    'class' => 'color9 font500',
                ...
                <?php
                    ...
                    $lbl_superior2 = '';
                    $cambia_superior2 = false;
                    if($id_inferiores && (count($id_inferiores)>0)){
                        $niveles_above = null;
                        if($empresa->cantidad_niveles == 2){
                            $niveles_above = NivelOrganizacional2::find()->where(['id_empresa'=>$empresa->id])->andWhere(['in','id',$id_inferiores])->andWhere(['status'=>1])->all();
                        ...
                        if($niveles_above){
                            foreach($niveles_above as $key=>$inferior){
                                $label_inferior = '';
                                if($empresa->cantidad_niveles == 2){
                                    $label_inferior = $inferior->nivelorganizacional2;
                                } else if($empresa->cantidad_niveles == 3){
                                    $label_inferior = $inferior->nivelorganizacional3;

                                    $super =  NivelOrganizacional2::findOne($inferior->id_nivelorganizacional2);
                                    if($super){
                                        if($lbl_superior != $super->nivelorganizacional2){
                                            $lbl_superior = $super->nivelorganizacional2;
                                    ...
                                    if($super){
                                        ...
                                        $super2 =  NivelOrganizacional2::findOne($super->id_nivelorganizacional2);
                                        if($super2){
                                            if($lbl_superior2 != $super2->nivelorganizacional2){
                                                $lbl_superior2 = $super2->nivelorganizacional2;
                                                $cambia_superior2 = true;
                                            } else {
                                                $cambia_superior2 = false;
                                            }
                                        }
                                ...
                                if($cambia_superior2){
                                    $ret_nivel .= '<tr>
                                    <th class="bg-dark text-light font12 font500" colspan=3>'.$lbl_superior2.'</th>
                                    <th class="font12 font500 text-center bgcolor14 p-2" colspan=1>'.number_format($super2->kpi_cumplimiento, 2, '.', ',').'%</th>
                                    </tr>';
                                }
