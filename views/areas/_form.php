...
<div class="ubicaciones-form">
    ...
    <div class="row my-3">
        <div class="col-lg-8" style="display:<?php echo $showempresa?>;">
            <?= $form->field($model, 'id_empresa')->widget(Select2::classname(), [
                    ...
                    'onchange' => 'cambiaEmpresagetcountry(this.value,"areas")'],
                    'pluginOptions' => [
                        'allowClear' => false
                    ],
    ...
    <div class="row my-3">
        <div class="col-lg-4">
            <?= $form->field($model, 'id_pais')->widget(Select2::classname(), [
                    'data' => $paises,
                    'options' => ['placeholder' => yii::t('app', 'SELECCIONA--'),
                    'onchange' => 'cambiaCountry(this.value,"areas")'],
                    'pluginOptions' => [
                        'allowClear' => false
                    ],
                    ]); ?>
    ...
    <div class="row my-3">
        <div class="col-lg-8">
            <?= $form->field($model, 'area')->textInput(['maxlength' => true,'onkeyup' => 'converToMayus(this);']) ?>
        </div>
        <div class="col-lg-2">
