...
/** @var app\models\LineasSearch $searchModel */
...
<div class="lineas-index">
    ...
    <div class="row mb-3">
        <div class="col-lg-3 d-grid">
            ...
            <?= Html::a('<span class="mx-2 small"><i class="bi bi-plus-lg"></i></span>Nueva Linea', ['create'], ['class' => 'btn btn-primary btnnew btn-block']) ?>
            <?php endif;?>
        </div>
