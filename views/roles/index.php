...
$this->title = Yii::t('app', 'Roles'.$name_empresa);
...
<div class="roles-index">
    ...
    if(Yii::$app->user->can('roles_actualizar')){
        $template .='{update}';
    }
    ?>
    ...
    <div class="row mb-3">
        <div class="col-lg-3 d-grid">
            <?php if(Yii::$app->user->can('roles_crear')):?>
            <?= Html::a('<span class="mx-2 small"><i class="bi bi-plus-lg"></i></span>Nuevo Rol', ['create'], ['class' => 'btn btn-primary btnnew btn-block']) ?>
            <?php endif;?>
        </div>
    </div>
    ...
    <?= GridView::widget([
        ...
        'columns' => [
            ...
            [
                'attribute' =>'nombre',
                'contentOptions' => ['class' => "y_centercenter font500",'style'=>'width:15%'],
                'filterInputOptions' => ['class' => 'icon-find form-control'],
            ],
            [
                'attribute' =>'color',
                'contentOptions' => ['class' => "y_centercenter font500",'style'=>'width:10%'],
                'filterInputOptions' => ['class' => 'icon-find form-control'],
                'format'=>'raw',
                'value'=>function($model){
                    $ret = '';
                    if($model->color){
                        $ret = '<div class="badge text-dark font12 m-1" style="background-color:'.$model->color.';"><span class="mx-2"><i class="bi bi-paint-bucket"></i></span>'.$model->color.'</div>';
                    }
                    return $ret;
                },
            ],
            [
                'attribute' =>'permisos',
                'contentOptions' => ['class' => "y_centercenter font500",'style'=>'width:70%'],
                'filterInputOptions' => ['class' => 'icon-find form-control'],
            ...
            [
                ...
                'buttons' => [
                    'view' =>  function($url,$model) {
                        return Html::a('<span class="color2"><i class="bi bi-eye-fill"></i><span>', Url::to(['roles/view','id' => $model->id]), [
                            'title' => Yii::t('app', 'Ver'),
                            'data-toggle'=>"tooltip",
                            'data-placement'=>"top",
                    ...
                    'update' =>  function($url,$model) {
                        return Html::a('<span class=""><i class="bi bi-pen-fill"></i><span>', Url::to(['roles/update','id' => $model->id]), [
