...
/** @var app\models\UbicacionesSearch $searchModel */
...
<div class="ubicaciones-index">
    ...
    <div class="row mb-3">
        <div class="col-lg-3 d-grid">
            ...
            <?= Html::a('<span class="mx-2 small"><i class="bi bi-plus-lg"></i></span>Nueva Ubicación', ['create'], ['class' => 'btn btn-primary btnnew btn-block']) ?>
            <?php endif;?>
        </div>
