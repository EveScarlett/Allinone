...
if($model->empresa){
    $nombre_empresa = $model->empresa->razon;
    $direccion_empresa = $model->empresa->direccion;
    $correo_empresa = $model->empresa->correo_privacidad;
}
?>
            ...
            <table style="line-height: 1.5; font-size:11px;width:100%;border-collapse: collapse;">
                <tbody>
                    ...
                    <tr>
                        <td colspan="4">
                            ...
                            if($model->fecha != null && $model->fecha != '' && $model->fecha != ' '){
                                $fecha_formato = date('d / m / Y', strtotime($model->fecha));
                            }
                        ...
                        <td colspan="3">
                            ...
                            $hora_formato = '';
                            if($model->fecha != null && $model->fecha != '' && $model->fecha != ' '){
                                $hora_formato = date('H : i', strtotime($model->hora));
                            }
                    ...
                    <tr>
                        ...
                        <!-- <td colspan="3" rowspan="5" class="text-center" style="border: 1px solid black;">
                            ...
                            if(isset($model->foto_web) && $model->foto_web != ""){
                                ...
                                $filePath = '/web'. '/resources/Empresas/'.$model->id_empresa.'/Trabajadores/'.$model->id.'/Documentos/'.$model->foto_web;
                    ...
                    <tr style="padding-top:20px;">
                        ...
                        <!-- <td colspan="2"></td>
                        <td colspan="9" class="text-justify" style="margin-top:20px;border:1px solid #BFD7EA;">
                            <?php
                            $ret = '';
                            if(isset($model->ife_reverso) && $model->ife_reverso != ""){
                                $filePath =  '/web'.'/resources/Empresas/'.$model->id_empresa.'/Trabajadores/'.$model->id.'/Documentos/'.$model->ife_reverso;
                                $ret = Html::img( $filePath, ['alt'=>' ', 'class' => "img-responsive",'style'=>'box-shadow: rgba(50, 50, 93, 0.25) 0px 13px 27px -5px, rgba(0, 0, 0, 0.3) 0px 8px 16px -8px; height:200px; width:320px;']);
                            }
                            echo $ret;
                            ?>
                    ...
                    <!-- <tr>
                        <td colspan="9" class="text-center">
                            <h3>Identificación oficial frontal </h3>
                        </td>
                        <td colspan="2"></td>
                        <td colspan="9" class="text-center">
                            <h3>Identificación oficial reverso</h3>
                        </td>
                    </tr>

                    <tr>
                        <td colspan="4" class=""></td>
                        <td colspan="12" class="text-center font500 borderbtn">
                            <?php
                            $ret = '';
                            if(isset($model->firma_ruta) && $model->firma_ruta != ""){
                              
                                $filePath =  '/web'.'/resources/Empresas/'.$model->id_empresa.'/Trabajadores/'.$model->id.'/Documentos/'.$model->firma_ruta;
