...
if(Yii::$app->user->identity->empresa_all != 1) {
    ...
    $estudio_tipo = [
    '10000'=>'--CLASIFICACIÓN POE--'
    ];
    $lista_estudios = ArrayHelper::map(Servicios::find()->orderBy('nombre')->all(), 'id', 'nombre');

    $estudios = $estudio_tipo + $lista_estudios;
    ...
    <div class="row mt-3">
        ...
        <div class="col-lg-8">
            ...
            <ul>
                ...
                <li class="color11">La primera columna del archivo .csv debe ser un dato que identifique al trabajador al cual se le realizará el POE, siendo una de las opciones: <b>ID TRABAJADOR, NUMERO TRABAJADOR, NOMBRE TRABAJADOR</b></li>
                <li class="">Acorde a esta primera columna, en el formulario deberá seleccionarse cual es el dato con el cual se buscará al trabajador(<b>ID TRABAJADOR, NUMERO TRABAJADOR, NOMBRE TRABAJADOR</b>), en la seccion <b>IDENTIFICADOR TRABAJADOR</b></li>
                <li class="">Las siguientes columnas corresponden a los estudios que se realizarán en los poes, por lo tanto seberán seleccionarse en la sección de estudios los que correspondan a cada columna.</li>
                <li class="color11">Las siguientes columnas del archivo .CSV deberán llenarse con SI o NO, dependiendo de si el trabajador se realizará dicho estudio (correspondiente a la columna) o no.</li>
                <!-- 
