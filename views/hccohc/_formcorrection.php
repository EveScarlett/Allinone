...
$array_grupo = ['1'=>'A','2'=>'B','3'=>'AB','4'=>'O'];
$array_rh = ['1'=>'POSITIVO (+)','2'=>'NEGATIVO (-)'];
...
?>
        ...
        <div class="hcc-ohc-form">
            ...
            <?php $form = ActiveForm::begin(['id'=>'formCorregir',
            ...
            <div class="container-fluid my-3 border30 bg-light p-4">
                ...
                <div class="row mt-5">
                    <div class="col-lg-4 d-grid">
                        <?= Html::button('Guardar <i class="bi bi-hdd"></i>', ['class' => 'btn btn-primary btnnew btn-block','id'=>'corregirHC']) ?>
                    </div>
                </div>
